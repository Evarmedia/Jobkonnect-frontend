...
const JobDetails = () => {
  ...
  return (
    <div className="m-10 max-w-3xl p-6 border rounded-lg shadow bg-gray-800 border-gray-700">
      ...
      <p className="mb-3 font-normal text-gray-700 dark:text-gray-400"><span className="text-white font-semibold">Requirements:</span> {job.requirements}</p>
