...
const JobDetails = () => {
  ...
  return (
    <div className='relative p-3'>
      <div className='relative m-10 max-w-3xl p-6 border rounded-lg shadow bg-gray-800 border-gray-700'>
        <h1 className='text-3xl capitalize text-gray-300  font-bold mb-4'>
          <span className='text-white font-semibold'>Job title:</span> {job.title}{" "}
        </h1>
        ...
        {role === "job_seeker" && (
          <NavLink to={`/applications_form/${job_id}`}>
