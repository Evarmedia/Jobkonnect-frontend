      ...
      <div className='container mx-auto p-6'>
        ...
        <div className='bg-white shadow-md rounded p-6'>
          <section className='mb-6'>
            ...
            <p>
              JobKonnect aims to bridge the gap between job seekers and
              employers by providing a seamless and efficient platform for job
              searching, application management, and recruitment processes.
            </p>
          </section>
          <section className='mb-6'>
            <h2 className='text-2xl font-semibold mb-4 text-blue-600'>
          ...
          <section className='mb-6'>
            ...
            <ul className='list-disc list-inside ml-4'>
              ...
              <li>
                View detailed profiles of applicants, including their resumes
                and cover letters.
              </li>
              <li>
          ...
          <section className='mb-6'>
            ...
            <p>
              We are dedicated to making the job search and recruitment process
              as smooth and efficient as possible. Our platform is designed with
              both job seekers and employers in mind, ensuring that each party
              can achieve their goals effectively. Join JobKonnect today and
              take the next step towards your career or hiring success.
            </p>
          </section>
